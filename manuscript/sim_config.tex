\begin{longtable}{| p{0.28\linewidth} | C{0.08\linewidth} | p{0.27\linewidth} | p{0.27\linewidth} | }
...
constraint\_optimal\_margin & 0.05 & Distance away from optimal before applying constraint & Large enough to prevent no feasible result \\ \hline
...
dyn\_model\_gen\_vel\_mag & 0.0077 & Maximum governing offset velocity magnitude per 1000 sim iterations & Achieve $\Delta F_{50}$ of -0.02 during tuning \\ \hline
