...
Simulation configuration is performed by creating a configuration object using the SimConfig() function. This object is used to enable simulation features and set feature parameters (Req. 9, 10). A comprehensive list of configuration parameters with setpoints and justification is provided in Section \ref{configparams}.
...
\begin{figure}
    ...
    \begin{minipage}[t]{0.46\textwidth}
        \centering
        \includegraphics[width=0.96\textwidth]{basic_eq_mdl_1_gov_fun.png}
        \caption{Governing function created using a spline basic function.}
        \label{fig:basic_eq_mdl_1_gov_fun}
    \end{minipage}\hfill
    \begin{minipage}[t]{0.46\textwidth}
        \centering
        \includegraphics[width=0.96\textwidth]{basic_eq_mdl_1_mdl_fun.png}
...
\begin{figure}
    ...
    \begin{minipage}[t]{0.46\textwidth}
        \centering
        \includegraphics[width=0.96\textwidth]{basic_eq_mdl_1_mdl_resp.png}
    ...
    \begin{minipage}[t]{0.46\textwidth}
        \centering
        \includegraphics[width=0.96\textwidth]{landscape_mdl_19_mdl_resp.png}
...
\begin{figure}
    ...
    \begin{minipage}[t]{0.46\textwidth}
        \centering
        \includegraphics[width=0.96\textwidth]{flat_mdl_1_mdl_resp_flat.png}
    ...
    \begin{minipage}[t]{0.46\textwidth}
        \centering
        \includegraphics[width=0.96\textwidth]{invert_mdl_1_mdl_resp_invert.png}
...
\begin{figure}
    ...
    \begin{minipage}[t]{0.46\textwidth}
        \centering
        \includegraphics[width=0.96\textwidth]{2d_const_3_1_base.png}
        \caption{Example composition function response of two models.}
        \label{fig:2d_const_3_1_base}
    \end{minipage}\hfill
    \begin{minipage}[t]{0.46\textwidth}
        \centering
        \includegraphics[width=0.96\textwidth]{2d_const_3_1_iso.png}
...
\begin{figure}
    ...
    \begin{minipage}[t]{0.46\textwidth}
        \centering
        \includegraphics[width=0.96\textwidth]{2d_const_3_1_iso_skew.png}
    ...
    \begin{minipage}[t]{0.46\textwidth}
        \centering
        \includegraphics[width=0.96\textwidth]{2d_const_3_1_iso_skew_const.png}
        \caption{Composition function response with added feasibility constraint feature.}
...
\begin{figure}
    ...
    \caption{An example iso-optimal surface for a 3-Dimensional composition function with skewing and constraint features.}
...
\begin{figure}
    ...
    \begin{minipage}[t]{0.46\textwidth}
        \centering
        \includegraphics[width=0.96\textwidth]{test_dyn_model.png}
    ...
    \begin{minipage}[t]{0.46\textwidth}
        \centering
        \includegraphics[width=0.96\textwidth]{test_dyn_input_shift.png}
...
\begin{figure}
    ...
    \begin{minipage}[t]{0.46\textwidth}
        \centering
        \includegraphics[width=0.96\textwidth]{test_dyn_map.png}
    ...
    \begin{minipage}[t]{0.46\textwidth}
        \centering
        \includegraphics[width=0.96\textwidth]{test_dyn_map_spline.png}
...
\begin{figure}
    ...
    \begin{minipage}[t]{0.46\textwidth}
        \centering
        \includegraphics[width=0.96\textwidth]{test_fidelity_var_1.png}
    ...
    \begin{minipage}[t]{0.46\textwidth}
        \centering
        \includegraphics[width=0.96\textwidth]{test_fidelity_var_2.png}
...
\begin{figure}
    ...
    \begin{minipage}[t]{0.46\textwidth}
        \centering
        \includegraphics[width=0.96\textwidth]{fault_mdl_5_mdl_resp_fault_degrade.png}
	\caption{Example model fault resulting in degraded response.}
	\label{fig:fault_mdl_5_mdl_resp_fault_degrade}
    \end{minipage}\hfill
    \begin{minipage}[t]{0.46\textwidth}
        \centering
        \includegraphics[width=0.96\textwidth]{fault_mdl_8_mdl_resp_fault_0.29.png}
...
\begin{figure}
    ...
    \begin{minipage}[t]{0.46\textwidth}
        \centering
        \includegraphics[width=0.96\textwidth]{comp2d_inp_model_noise_faults.png}
    ...
    \begin{minipage}[t]{0.46\textwidth}
        \centering
        \includegraphics[width=0.96\textwidth]{out_adversarial_fun.png}
...
\begin{figure}
    ...
    \begin{minipage}[t]{0.46\textwidth}
        \centering
        \includegraphics[width=0.96\textwidth]{test_adv_offset_l2r.png}
    ...
    \begin{minipage}[t]{0.46\textwidth}
        \centering
        \includegraphics[width=0.96\textwidth]{test_adv_offset_r2l.png}
...
\begin{figure}
    ...
    \begin{minipage}[t]{0.46\textwidth}
        \centering
        \includegraphics[width=0.96\textwidth]{test_adv_fail.png}
    ...
    \begin{minipage}[t]{0.46\textwidth}
        \centering
        \includegraphics[width=0.96\textwidth]{test_adv_noise.png}
...
When Random Search is used, all design variables and node inputs are chosen from a random distribution in the range [0, 1) using the Xoshiro generator. The random number seed used by all optimizers starts at zero at the begining of the treatment and increments by one after each replicate resulting in three-hundred total seeds per treatment.


\subsection{Experiment 0. Configuration Parameter Tuning}
\label{configparams}

Prior to running the performance comparison experiments, the simulation configuration parameters were tuned. As with the comparison experiments, ten replicates of thirty scenario seeds for ten-thousand iterations were used during each tuning cycle. Parameters were tuned to allow features to have an observable impact without overly burdening or improving performance. The descriptions of parameters with setpoint justification is provided below in Table \ref{tbl:sim-config}.

Before tuning, the following inputs were explicitly selected without tuning: model noise sigma, fidelity power, flattening rate, inversion rate, random fault rate, random infeasible rate, random fitness rate, constraint input margin, constraint optimal margin, min knots, max knots, min scale knots, max scale knots, min constraint knots, max constraint knots, max skew magnitude, knot feedback, adversarial noise factor, adversarial incorrect factor, adversarial feedback, min adversarial knots, max adversarial knots,
dyn input map freq min, dyn input map freq max, dyn network map freq min, dyn network map freq max, dyn input shift freq min, dyn input shift freq max, node visit required freq, and node random connection freq.
...
\colorbox{yellow}{remove.}\lipsum[1]
...
\begin{table}[H]
	...
	\label{tbl:exp1}	
	\newcolumntype{C}[1]{>{\centering\arraybackslash}p{#1}}
	\begin{tabular}{| C{0.12\linewidth} | C{0.08\linewidth} | C{0.08\linewidth} | C{0.08\linewidth} | C{0.08\linewidth} | C{0.08\linewidth} | C{0.08\linewidth} | C{0.08\linewidth} | C{0.08\linewidth} | }
	\hline
...
\begin{figure}
    ...
    \begin{minipage}[t]{0.46\textwidth}
        \centering
        \includegraphics[width=0.96\textwidth]{test_exp_1_compare_rnd.png}
	\caption{asdf.}
	\label{fig:test_exp_1_compare_rnd}
    \end{minipage}\hfill
    \begin{minipage}[t]{0.46\textwidth}
        \centering
        \includegraphics[width=0.96\textwidth]{test_exp_1_compare_eca.png}
	\caption{asdf.}
...
\begin{figure}
    ...
    \begin{minipage}[t]{0.46\textwidth}
        \centering
        \includegraphics[width=0.96\textwidth]{test_exp_1_compare_pso.png}
	\caption{asdf.}
	\label{fig:test_exp_1_compare_pso}
    \end{minipage}\hfill
    \begin{minipage}[t]{0.46\textwidth}
        \centering
        \includegraphics[width=0.96\textwidth]{test_exp_1_compare_sa.png}
	\caption{asdf.}
...
\begin{figure}
    ...
    \begin{minipage}[t]{0.46\textwidth}
        \centering
        \includegraphics[width=0.96\textwidth]{test_exp_1b_compare_rnd.png}
	\caption{asdf.}
	\label{fig:test_exp_1b_compare_rnd}
    \end{minipage}\hfill
    \begin{minipage}[t]{0.46\textwidth}
        \centering
        \includegraphics[width=0.96\textwidth]{test_exp_1b_compare_eca.png}
	\caption{asdf.}
...
\begin{figure}
    ...
    \begin{minipage}[t]{0.46\textwidth}
        \centering
        \includegraphics[width=0.96\textwidth]{test_exp_1b_compare_pso.png}
	\caption{asdf.}
	\label{fig:test_exp_1b_compare_pso}
    \end{minipage}\hfill
    \begin{minipage}[t]{0.46\textwidth}
        \centering
        \includegraphics[width=0.96\textwidth]{test_exp_1b_compare_sa.png}
	\caption{asdf.}
...
\begin{figure}
    ...
    \begin{minipage}[t]{0.46\textwidth}
        \centering
        \includegraphics[width=0.96\textwidth]{test_exp_2_compare_4dim_rnd.png}
	\caption{asdf.}
	\label{fig:test_exp_2_compare_4dim_rnd}
    \end{minipage}\hfill
    \begin{minipage}[t]{0.46\textwidth}
        \centering
        \includegraphics[width=0.96\textwidth]{test_exp_2_compare_4dim_eca.png}
	\caption{asdf.}
...
\begin{figure}
    ...
    \begin{minipage}[t]{0.46\textwidth}
        \centering
        \includegraphics[width=0.96\textwidth]{test_exp_2b_compare_4dim_rnd.png}
	\caption{asdf.}
	\label{fig:test_exp_2b_compare_4dim_rnd}
    \end{minipage}\hfill
    \begin{minipage}[t]{0.46\textwidth}
        \centering
        \includegraphics[width=0.96\textwidth]{test_exp_2b_compare_4dim_eca.png}
	\caption{asdf.}
...
\begin{longtable}{| p{0.2\linewidth} | C{0.12\linewidth} | C{0.12\linewidth} | C{0.12\linewidth} | C{0.12\linewidth} | C{0.12\linewidth} | }
...
random\_fitness & -0.001 & -0.001 & -0.014 & -0.013

\label{tbl:exp3-parallel} \\ \hline
...
random\_fitness & -0.724 & -0.765 & -0.800 & -0.849


\label{tbl:exp3-series} \\ \hline
...
\begin{figure}
    ...
    \begin{minipage}[t]{0.46\textwidth}
        \centering
        \includegraphics[width=0.96\textwidth]{test_exp_3_parallel_rnd.png}
	\caption{asdf.}
	\label{fig:test_exp_3_parallel_rnd}
    \end{minipage}\hfill
    \begin{minipage}[t]{0.46\textwidth}
        \centering
        \includegraphics[width=0.96\textwidth]{test_exp_3_parallel_eca.png}
	\caption{asdf.}
...
\begin{figure}
    ...
    \begin{minipage}[t]{0.46\textwidth}
        \centering
        \includegraphics[width=0.96\textwidth]{test_exp_3_series_rnd.png}
	\caption{asdf.}
	\label{fig:test_exp_3_series_rnd}
    \end{minipage}\hfill
    \begin{minipage}[t]{0.46\textwidth}
        \centering
        \includegraphics[width=0.96\textwidth]{test_exp_3_series_eca.png}
	\caption{asdf.}
