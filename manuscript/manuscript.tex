...
\begin{figure}
	\centering
	\includegraphics[width=0.6\textwidth]{basic_eq_mdl_1_gov_fun.png}
...
\begin{figure}
	\centering
	\includegraphics[width=0.6\textwidth]{basic_eq_mdl_1_mdl_fun.png}
...
\begin{figure}
	\centering
	\includegraphics[width=0.6\textwidth]{basic_eq_mdl_1_mdl_resp.png}
...
\begin{figure}
	\centering
	\includegraphics[width=0.6\textwidth]{landscape_mdl_19_mdl_resp.png}
...
\begin{figure}
	\centering
	\includegraphics[width=0.6\textwidth]{flat_mdl_1_mdl_resp_flat.png}
...
\begin{figure}
	\centering
	\includegraphics[width=0.6\textwidth]{invert_mdl_1_mdl_resp_invert.png}
...
\begin{figure}
	\centering
	\includegraphics[width=0.6\textwidth]{2d_const_3_1_base.png}
...
\begin{figure}
	\centering
	\includegraphics[width=0.6\textwidth]{2d_const_3_1_iso.png}
...
\begin{figure}
	\centering
	\includegraphics[width=0.6\textwidth]{2d_const_3_1_iso_skew_const.png}
...
The simulation supports a variety of semi-cooperative features. These are features in which the simulation intentionally reports randomly incorrect results (Req. 68), to include feasibility or infeasibility (Req. 69), as well as fails to execute based on pre-determined fault injection thresholds (Req. 65).

During scenario creation, some input dimensions are randomly selected to include fault injection with a corresponding failure threshold and magnitude. When a fault is present and the evaluated model response falls below the failure threshold the model response will be either degraded by scaling downward (Fig. \ref{fig:fault_mdl_5_mdl_resp_fault_degrade}) or will result in a simulation executive failure (Fig. \ref{fig:fault_mdl_8_mdl_resp_fault_029}). In the event of an executive failure the simulation will report 0.0 for the fitness score and will provide no indication that a failure was triggered. Fault via degradation and fault via executive failure result in separable and non-separable failure regions (Req. 66).

\begin{figure}
	\centering
	\includegraphics[width=0.6\textwidth]{fault_mdl_5_mdl_resp_fault_degrade.png}
...
\begin{figure}
	\centering
	\includegraphics[width=0.6\textwidth]{fault_mdl_8_mdl_resp_fault_0.29.png}
