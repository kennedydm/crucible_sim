...
\subsection{Spline Basic Functions}
...
Flattening may occur when a governing or model function is clamped in the range [0, 1], however additional random flattening can be injected using the enable\_flattening configuration parameter (Figure \ref{fig:flat_mdl_1_mdl_resp_flat}). Moreover, additional random discontinuity can be injected by randomly inverting regions using the enable\_inversion configuration parameter (Figure \ref{fig:invert_mdl_1_mdl_resp_invert}).
